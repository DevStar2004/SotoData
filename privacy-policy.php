		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-xs-12 ">
					...
					<h2 class="title-box">What personal information do we collect from the people that visit our blog, website or app?</h2>
					...
					<h2 class="title-box">When do we collect information?</h2>
					...
					<h2 class="title-box">How do we use your information?</h2>
					...
					<h2 class="title-box">How do we protect your information?</h2>
					...
					<h2 class="title-box">Do we use 'cookies'?</h2>
					...
					<h2 class="title-box">We use cookies to:</h2>
					<ul>
					...
					<h2 class="title-box">If users disable cookies in their browser:</h2>
					<p>If you turn cookies off it will turn off some of the features of the site.</p>
					<h2 class="title-box">Third-party disclosure</h2>
					...
					<h2 class="title-box">We have implemented the following:</h2>
						<ul>
					...
					<h2 class="title-box">Opting out:</h2>
					...
					<h2 class="title-box">California Online Privacy Protection Act</h2>
					<p>CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy. The law's reach stretches well beyond California to require any person or company in the United States (and conceivably the world) that operates websites collecting Personally Identifiable Information from California consumers to post a conspicuous privacy policy on its website stating exactly the information being collected and those individuals or companies with whom it is being shared. - See more at: http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf</p>
					<h2 class="title-box">According to CalOPPA, we agree to the following:</h2>
...
Our Privacy Policy link includes the word 'Privacy' and can easily be found on the page specified above.</p>
					...
					<h2 class="title-box">How does our site handle Do Not Track signals?</h2>
					<p>We honor Do Not Track signals and Do Not Track, plant cookies, or use advertising when a Do Not Track (DNT) browser mechanism is in place.</p>
					<h2 class="title-box">Does our site allow third-party behavioral tracking?</h2>
					<p>It's also important to note that we allow third-party behavioral tracking</p>
					<h2 class="title-box">COPPA (Children Online Privacy Protection Act)</h2>
...
Do we let third-parties, including ad networks or plug-ins collect PII from children under 13?</p>
					<h2 class="title-box">Fair Information Practices</h2>
					<p>The Fair Information Practices Principles form the backbone of privacy law in the United States and the concepts they include have played a significant role in the development of data protection laws around the globe. Understanding the Fair Information Practice Principles and how they should be implemented is critical to comply with the various privacy laws that protect personal information.</p>
					<h2 class="title-box">In order to be in line with Fair Information Practices we will take the following responsive action, should a data breach occur:</h2>
					<p>We will notify you via email</p>
					<ul>
						<li>Within 7 business days</li>
					</ul>
					<p>We also agree to the Individual Redress Principle which requires that individuals have the right to legally pursue enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or government agencies to investigate and/or prosecute non-compliance by data processors.</p>
					<h2 class="title-box">CAN SPAM Act</h2>
					<p>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.</p>
					<h2 class="title-box">We collect your email address in order to:</h2>
					<ul>
					...
					<h2 class="title-box">To be in accordance with CANSPAM, we agree to the following:</h2>
					<ul>
					...
					<h2 class="title-box">If at any time you would like to unsubscribe from receiving future emails, you can email us at</h2>
