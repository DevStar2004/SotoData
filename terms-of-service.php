<?php include 'header.php' ?>
	...
	<section id="privacy-content" class="section-one" style="margin: 40px 10px;">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-xs-12 ">
					<h2 class="title-box">Introduction </h2>
					<p>Welcome to www.legaldata.logiclabsllc.com. This website is owned and operated by SotoData LLC. By visiting our website and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as 'User Agreement'), along with the terms and conditions as stated in our Privacy Policy (please refer to the Privacy Policy section below for more information). </p>
					<p>This agreement is in effect as of May 01, 2018. </p>
					...
					<h2 class="title-box">Responsible Use and Conduct </h2>
					...
					<h2 class="title-box">Limitation of Warranties </h2>
					...
					<ul>
						...
						<li>no information or advice, whether expressed, implied, oral or written, obtained by you from SotoData LLC or through any Resources we provide shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.</li>
					</ul>
					<h2 class="title-box">Limitation of Liability</h2>
					<p>In conjunction with the Limitation of Warranties as explained above, you expressly understand and agree that any claim against us shall be limited to the amount you paid, if any, for use of products and/or services. SotoData LLC will not be liable for any direct, indirect, incidental, consequential or exemplary loss or damages which may be incurred by you as a result of using our Resources, or as a result of any changes, data loss or corruption, cancellation, loss of access, or downtime to the full extent that applicable limitation of liability laws apply. </p>
					<h2 class="title-box">Copyrights/Trademarks </h2>
					<p>All content and materials available on www.legaldata.logiclabsllc.com, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of SotoData LLC, and are protected by applicable copyright and trademark law. Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by SotoData LLC. </p>
					<h2 class="title-box">Termination of Use </h2>
					...
					<h2 class="title-box">Governing Law </h2>
					<p>This website is controlled by SotoData LLC from our offices located in the state of Wyoming, USA. It can be accessed by most countries around the world. As each country has laws that may differ from those of Wyoming, by accessing our website, you agree that the statutes and laws of Wyoming, without regard to the conflict of laws and the United Nations Convention on the International Sales of Goods, will apply to all matters relating to the use of this website and the purchase of any products or services through this site. </p>
					<p>Furthermore, any action to enforce this User Agreement shall be brought in the federal or state courts located in USA, Wyoming You hereby agree to personal jurisdiction by such courts, and waive any jurisdictional, venue, or inconvenient forum objections to such courts. </p>
					<h2 class="title-box">Guarantee </h2>
					<p>UNLESS OTHERWISE EXPRESSED, SotoData LLC EXPRESSLY DISCLAIMS ALL WARRANTIES AND CONDITIONS OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT. </p>
					<h2 class="title-box">Contacting Us</h2>
					<p>If there are any questions regarding this privacy policy, you may contact us using the information below.</p>
					<ul class="address-list">
						<li>www.legaldata.logiclabsllc.com</li>
						<li>1712 Pioneer Ave<br>Cheyenne, Wyoming 82001<br>USA</li>
						<li>support@legaldata.logiclabsllc.com</li>
					</ul>
	...
	<script type="text/javascript" src="js/main.js?ver=4.8.4"></script>
