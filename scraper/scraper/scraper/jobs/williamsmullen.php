...
foreach ($q as $row) {
    ...
    $values['description'] = superTrim($html->find('#main-bio', 0)->innertext);;
    ...
    $practice_area_html = @str_get_html(get_string_between($html, '<h3><span class="prefix">Related</span> Practices &amp; Industries</h3>', '</ul>'), 2);
