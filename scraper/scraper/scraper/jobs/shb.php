...
foreach ($q as $row) {
    ...
    $pData['phone'] = $html->find('.person-snapshot-phone', 0)->plaintext;
    ...
    $values['description'] = superTrim($html->find('.rich-text', 0)->innertext);;
    ...
    $practice_area_html = @str_get_html(get_string_between($html, '<span class="people-related-services-label grid-col-3">Practices</span>', '</div>'), 2);
