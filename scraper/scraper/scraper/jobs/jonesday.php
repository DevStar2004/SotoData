...
foreach ($q as $row) {
    ...
    $education = array();
    $education_html = @str_get_html(get_string_between($html, 'v-on:click="toggle()">Education', '</ul>'));
    ...
    $practice_html = @str_get_html(get_string_between($html, 'v-on:click="toggle()">Practices', '</ul>'));
