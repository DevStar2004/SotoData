...
foreach ($q as $row) {
    ...
    $values['description'] = @$html->find('.col-sm-12.col-md-6', 1)->innertext;
    ...
    $admission_html = @str_get_html(get_string_between($html, 'Bar and Court Admissions', '<div class="tab-pane fade"'));
    ...
    $practice_html = @str_get_html(get_string_between($html, 'Related Practices', '</ul>'));
