...
$spider_name = 'orrick';
$firm_name = 'Orrick Herrington & Sutcliffe LLP';
...
foreach ($q as $row) {
    ...
    $values['description'] = superTrim($html->find('.editor-wrapper', 0)->innertext);;
    ...
    $admission_html = @str_get_html(get_string_between($html, 'Admitted In', '</ul>'));
