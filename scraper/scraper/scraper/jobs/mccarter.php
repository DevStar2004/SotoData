...
$firm_name = 'McCarter & English, LLP';
...
foreach ($q as $row) {
    ...
    $positions = json_encode($pData['taxonomies']['me_search_position_taxonomy']);

    $values['description'] = $pData['post_excerpt'];
 
    $photo = $pData['images']['large']['url'];
    $thumb = $photo;

    $education = $pData['taxonomies']['poa_schools_taxonomy'];
    ...
    $practice_areas = $pData['relationships']['poa_practice'];
