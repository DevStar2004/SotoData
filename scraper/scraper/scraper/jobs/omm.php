...
foreach ($q as $row) {
    ...
    $values['description'] = superTrim($html->find('.ui-tabs-panel.ui-widget-content.ui-corner-bottom p', 0)->innertext);;
    ...
    $practice_area_html = @str_get_html(get_string_between($html, '<h2>Areas of Focus', '</p>'), 2);
