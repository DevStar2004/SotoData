...
$spider_name = 'stblaw';
$firm_name = 'Simpson Thacher & Bartlett LLP';
...
foreach ($q as $row) {
    ...
    $values['description'] = superTrim($html->find('.bio-content-long', 0)->innertext);;
 
    $photo = $base_url.$pData['picture200mhUrl'];
    $thumb = $photo;
    ...
    $practice_area_html = @str_get_html(get_string_between($html, '<div id="bioRightColPracticeFocus" class="bio-right-column-section">', '</ul>'), 2);
