...
foreach ($q as $row) {
    ...
    $admission_html = @str_get_html(get_string_between($html, '<h3 class="rte-list__title">Admitted to Practice</h3>', '</ul>'));
    ...
    $primaryAddress = $html->find('.bio-hero__contact-item .bio-hero__secondary', 0)->plaintext;
