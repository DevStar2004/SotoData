...
$spider_name = 'cahill';
$firm_name = 'Cahill Gordon & Reindel LLP';
...
foreach ($q as $row) {
    ...
    $values['description'] = $html->find('#overview', 0)->innertext;
    ...
    $admission_html = @str_get_html(get_string_between($html, '<h3>Admission</h3>', '</div>'));
    ...
    $primaryAddress = explode('<br/>', $html->find('.container.bio .col-md-4 div', 0)->innertext);
    $primaryAddress = strip_tags(end($primaryAddress));
